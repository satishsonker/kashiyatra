        ...
        <div className="btn-group">
          {
            option.buttons.map((ele, index) => {
              return <button 
                            ...
                            onClick={e =>ele.link!==undefined? navigate(ele.link): customButtonHandler(ele)} 
                            data-bs-toggle={ele.modelId===undefined?"":'modal'} 
                            data-bs-target={ele.modelId===undefined?"":"#" + ele.modelId}>
                              <i className={ele.icon}></i> {ele.text}
                            </button>
            })
          }
        </div>
