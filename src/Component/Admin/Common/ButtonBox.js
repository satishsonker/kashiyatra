...
const modifyOnType = (type, text, className,icon) => {
    ...
    if (type.toLowerCase() === "cancel") {
        return {
            icon:icon===""?"fa-solid fa-circle-xmark":icon,
    ...
    if (type.toLowerCase() === "update") {
        return {
            icon: icon===""?"fa-solid fa-arrow-clockwise":icon,
    ...
    if (type.toLowerCase() === "upload") {
        return {
            icon: icon===""?"fa-solid fa-cloud-arrow-up":icon,
    ...
    if (type.toLowerCase() === "go") {
        return {
            icon: icon===""?"fa-solid fa-circle-arrow-left":icon,
            text: text === "" ? "Go" : text,
            className: className += " btn-success"
        }
    }
    if (type.toLowerCase() === "back") {
        return {
            icon: icon===""?"fa-solid fa-arrow-left":icon,
            text: text === "" ? "Back" : text,
